...
I found ChiefGyk3d/siem-docker-stack, which looked perfect until I tried to get it running.  It seems to be vibe coded and doesn't actually work yet.  I'll probably use parts from that here, so they deserve some credit at least.
